...
local Target = game:GetService("ReplicatedStorage") -- Directory to scan
...
local WaitTime = 2 -- Reccomended wait time is 2
...
print("------------------------------------------------------------------")
print("Backdoor Scanner v1.2.3a -- Made by Indica")
print("------------------------------------------------------------------")
...
showHint("Starting Scan . . . This could take a while.")
wait(1)
...
if foundBackdoor == false then
	...
	showHint("Couldn't find a backdoor in the target :(")
else
